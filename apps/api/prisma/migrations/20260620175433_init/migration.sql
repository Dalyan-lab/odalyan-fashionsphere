-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'SELLER', 'CUSTOMER', 'MARKETING_AGENCY');
...
-- CreateEnum
CREATE TYPE "ProductCategory" AS ENUM ('HOMME', 'FEMME', 'ENFANT', 'LUXE', 'SPORT', 'ACCESSOIRES');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PAID', 'PROCESSING', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "PaymentProvider" AS ENUM ('STRIPE', 'PAYPAL', 'MOBILE_MONEY');
